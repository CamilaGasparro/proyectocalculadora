...
function addNumberInput(value) {
    ...
    if(inputValue === "0" && inputValue.length === 1 && value !== ",") { // si su valor es cero y su tamaño es 1
        inputScreen.value = value;
        return;
    }//para añadir valores(lo sustituye y cuando es con coma solo lo pone al lado)
